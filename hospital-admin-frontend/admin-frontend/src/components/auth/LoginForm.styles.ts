...
export const pageStyles: SxProps<Theme> = {
    ...
    background: '#f5f5f5', // Fondo más simple
    p: 2,
};
...
export const medicalIconStyles = (theme: Theme): SxProps<Theme> => ({
  fontSize: 42,
...
export const paperStyles = (theme: Theme): SxProps<Theme> => ({
  p: { xs: 3, sm: 5 },
  width: '100%',
  maxWidth: 500,
  background: 'white',
...
export const formTitleStyles = (theme: Theme): SxProps<Theme> => ({
  fontWeight: 600,
  color: theme.palette.text.primary,
  mb: 1
});

export const formSubtitleStyles = (theme: Theme): SxProps<Theme> => ({
...
export const versionStyles = (theme: Theme): SxProps<Theme> => ({
  color: theme.palette.text.secondary,
  fontSize: '0.75rem',
});